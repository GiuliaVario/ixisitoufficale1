...
export default function Hero() {
  return (
    <section
      ...
      className="bg-[var(--brand-bg)] text-[var(--brand-fg)] pt-[calc(env(safe-area-inset-top,0)+8px)]"
    >
      <Container>
        <div className="text-left py-8 sm:py-10 md:py-12 lg:py-14">
          <h1
            className="
